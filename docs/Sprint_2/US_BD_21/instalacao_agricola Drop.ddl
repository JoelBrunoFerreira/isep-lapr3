...
DROP TABLE PlanoFertilizacao_FatorProdução CASCADE CONSTRAINTS;
DROP TABLE PlanoRega CASCADE CONSTRAINTS;
DROP TABLE PlanoRega_FatorProdução CASCADE CONSTRAINTS;
...
DROP TABLE Setor_Parcela CASCADE CONSTRAINTS;
