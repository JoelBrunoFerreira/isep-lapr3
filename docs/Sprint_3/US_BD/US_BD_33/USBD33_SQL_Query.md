# US BD 33
* USBD33 Calcular e retornar uma lista de cultivos que tiveram a maior duração de rega num determinado ano civil.
...
![resultado_USBD33](Images/resultado_USBD33.png)
